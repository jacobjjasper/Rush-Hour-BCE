...
## Data
The following games will be played. The data files of these games are in the [data](https://github.com/jacobjjasper/Rush-Hour-BCE/tree/master/data) folder and contain:
